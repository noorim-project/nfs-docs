# NFS-API OpenAPI Specification
[![Build Status](https://travis-ci.com/noorim-project/nfs-docs.svg?branch=master)](https://travis-ci.com/noorim-project/nfs-docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://noorim-project.github.io/nfs-docs/)
- [SwaggerUI](https://noorim-project.github.io/nfs-docs/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://noorim-project.github.io/nfs-docs/openapi.json) [YAML](https://noorim-project.github.io/nfs-docs/openapi.yaml)
